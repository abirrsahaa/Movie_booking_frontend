                ...
                <FormControl>
                  <div className="flex items-center gap-2">
                    <input
                      type="checkbox"
                      id="recommendation"
                      className="h-5 w-5 accent-[#877EFF] border-none focus:ring-2 focus:ring-offset-2 focus:ring-[#877EFF]"
                      ...
                      ref={field.ref}
                    />
                    <label htmlFor="recommendation" className="text-sm text-[#EFEFEF]">
                      I want weekly newsletters.
                    </label>
                  </div>
                </FormControl>
                <FormMessage />
